...
class NavigationTest(BaseCase):
    ...
    def test_05_change_region(self):
        # 
        self.get(self.base_url+'/dolce-gabbana/s/1495')
        # получаем английскую цену
        eng_price = self.get_text('//article[1]/a/div[2]/p[3]/span[2]')
        ...
        # получаем русскую цену
        ru_price = self.get_text('//article[1]/a/div[2]/p[3]/span[2]')
        # английская цена не должна совпадать с русской
